...
* [从零开始学Swift计时器App开发](http://swiftist.org/topics/96): "通过完成此教程，我对Swift语言的理解也更进了一步。Swift是一门全新的语言，作为开发者，我们需要不断加深对这门语言的理解，并灵活使用语言提供的特性来编程。..."  by [李洁信](http://weibo.com/u/1780854425) 
